 ...
 *  that property name is activityOf[launcherName].
...
/**
 * Uses this annotation specify a activity result contract for this activity support
 * *ResultApi* for activity launcher provide to dependant module uses.
 *
