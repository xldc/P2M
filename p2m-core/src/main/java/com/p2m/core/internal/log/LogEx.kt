...
internal fun logI(msg: String){
    P2M.getConfigManager().logger?.log(Level.INFO, msg)
}

internal fun logD(msg: String){
    P2M.getConfigManager().logger?.log(Level.DEBUG, msg)
}

internal fun logW(msg: String){
    P2M.getConfigManager().logger?.log(Level.WARNING, msg)
}

internal fun logE(msg: String, throwable: Throwable? = null){
    P2M.getConfigManager().logger?.log(Level.ERROR, msg, throwable)
}